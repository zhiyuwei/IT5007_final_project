...
class BookAdd extends React.Component {
  ...
  handleSubmit(e) {
    ...
    if (form.title.value==""||form.publisher.value==""||form.author.value==""||form.number.value=="") {
      alert('Please fill in the book\'s title, publisher, author and number.');
    }
    else{
      const book = {
        ...
        place:form.place.value,date:form.date.value,
        intro:form.intro.value,location:form.location.value,
      }
      this.props.addBook(book);
      form.title.value = ""; form.publisher.value = "";
      form.author.value = ""; form.number.value = "";
      form.image.value = "";
      form.place.value = "";form.date.value = "";
      form.intro.value = ""; form.location.value = "";
    }
  ...
  render() {
    return (
      ...
      <form name="bookAdd" onSubmit={this.handleSubmit}>
        ...
        <input type="text" name="place" placeholder="Public place" />&emsp;
        <input type="text" name="date" placeholder="Public date" />&emsp;
        <input type="text" name="intro" placeholder="Introduction" />&emsp;
        <input type="text" name="location" placeholder="Location" />&emsp;
        <button>Add</button>
      </form>
    );
  }
